...
if ($_POST) {
  ...
  $extra_healthy_talent = new Talent(50, 1500,1.305, $_POST['extra_healthy']);
  $talents['extra_healthy'] = $extra_healthy_talent;
  $mission_adrenaline_talent = new Talent(50, 125000,1.153, $_POST['mission_adrenaline'], '+', $_POST['mission_adrenaline'], 10);
  ...
  $passive_criticals_talent = new Talent(50, 10,1.1, $_POST['passive_criticals'], '+', $_POST['passive_criticals'], 1);
  $talents['passive_criticals'] = $passive_criticals_talent;
  $set_bonus_talent = new Talent(50, 25, 1.1, $_POST['set_bonus'], '+', $_POST['set_bonus'], 20);
  ...
  $apprentice_crafter_talent = new Talent(-1, 200,1.1, $_POST['apprentice_crafter'], '+', $_POST['apprentice_crafter'], $_POST['common_and_uncommon_recipies'] * 2);
  ...
  $surplus_cooldown_talent = new Talent(50, 100,1.1, $_POST['surplus_cooldown'], '+', $_POST['cooldown_reduction'] - 50, $_POST['surplus_cooldown']/4);
  ...
  $well_equiped_talent = new Talent(50, 500,1.075, $_POST['well_equiped'], '+', $_POST['well_equiped'], 20 * $_POST['epics_on_main_dps']);
  $talents['well_equiped'] = $well_equiped_talent;
  $swap_day_talent = new Talent(50, 500,1.075, $_POST['swap_day'], '+', $_POST['swap_day'], (20 * $_POST['epics_on_benched_crusaders']));
  $talents['swap_day'] = $swap_day_talent;
  $synergy_talent = new Talent(20, 300,1.85, $_POST['synergy']);
  $talents['synergy'] = $synergy_talent;
  $legendary_benefits_talent = new Talent(50, 10000,1.1, $_POST['legendary_benefits'], '+', $_POST['legendary_benefits'], $_POST['legendaries']);
  ...
  $golden_age_talent = new Talent(50, 7500,1.12, $_POST['golden_age'], '+', $_POST['golden_age'], $_POST['gold_bonus_provided_by_crusaders']);
  ...
  $cheer_squad_talent = new Talent(50, 166000,1.165, $_POST['cheer_squad'], '+', $_POST['cheer_squad'], ($_POST['crusaders_owned'] - $_POST['crusaders_in_formation']));
  ...
  $maxed_power_talent = new Talent(50, 75000000, 1.3, $_POST['maxed_power'], '*', 0, 1, (int) $_POST['maxed_power']);
  $talents['maxed_power'] = $maxed_power_talent;
  $idolatry_talent = new Talent(20, 50000000,1.5, $_POST['idolatry'], '*', floor(log($_POST['total_idols'], 10)), 20, (int) $_POST['idolatry']);
  ...
  $legendary_friendship_talent = new Talent(25, 7500000000, 1.56, $_POST['legendary_friendship'], '*', $_POST['main_dps_benched_crusaders_legendaries'], 5, (int) $_POST['legendary_friendship']);
  $talents['legendary_friendship'] = $legendary_friendship_talent;
  $golden_friendship_talent = new Talent(25, 8000000000,1.395, $_POST['golden_friendship'], '*', $_POST['main_dps_benched_crusaders_golden_gear'], 5, (int) $_POST['golden_friendship']);
  $talents['golden_friendship'] = $golden_friendship_talent;
  $friendly_helpers_talent = new Talent(50, 500000000,1.26, $_POST['friendly_helpers'], '*', $_POST['taskmasters_owned'], 10, (int) $_POST['friendly_helpers']);
  ...
  $extra_training_talent = new Talent(40, 1000, 1.075, $_POST['extra_training'], '*', 300, 1, 1);
  ...
  $superior_training_talent = new Talent(80, 5000, 1.0888, $_POST['superior_training'], '*', 300, 1, 1);
  ...
  $tenk_training_talent = new Talent(80, 140000, 1.083, $_POST['tenk_training'], '*', 300, 1, 1);
  $talents['tenk_training'] = $tenk_training_talent;
  $bonus_training_talent = new Talent(33, 225000, 1.31, $_POST['bonus_training']);
  ...
  $montage_training_talent = new Talent(120, 35000000, 1.065, $_POST['montage_training'], '*', 300, 1, 1);
  ...
  $magical_training_talent = new Talent(-1, 20000000000, 1.285, $_POST['magical_training'], '*', $_POST['magical_training'], 300, 1, 1);
  ...
  //var_dump('============== $user->get_total_damage()) ==========');
  //var_dump($user->get_total_damage());
  echo "<br>";
  echo "Final Damage " . $base_damage * $user->get_total_damage() . "<br>";
  echo "Talents at max level: " . $user->talents_at_max . "<br>";
}

class Talent {
  function __construct($max_level, $base_cost, $level_multiplier, $current_level = 0, $damage_type = '', $stacks = '', $damage_base = '', $multiplicative_damage_base_multiplier = 1, $effect = '') {
  ...
  public function get_current_damage() {
    ...
    if ($this->damage_type == '+') {
      ...
      //Leave here for reference for how to format talents
      //Talent(50, 500000000, 1.26, $_POST['friendly_helpers'], '*', $_POST['taskmasters_owned'], 10, $_POST['friendly_helpers']);
      $damage = (pow(1 + $this->damage_base / 100 *
      $this->multiplicative_damage_base_multiplier,
      $this->stacks) - 1) * 100;
    }
    return $damage;
  }
