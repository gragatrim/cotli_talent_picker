...
class Talent {
  ...
  function get_multiplicative_damage() {
    ...
    } else if ($this->name == 'front_line_fire' || $this->name == 'formation_full_up' || $this->name == 'must_be_magic' || $this->name == 'backline_defensive' || $this->name == 'power_saws_ablaze') {
